			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.LeJiawei.model.Order o=(com.LeJiawei.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.LeJiawei.dao.UserDao userDao=new com.LeJiawei.dao.UserDao();
						...
						<%
							...
							String paymentType=com.LeJiawei.model.Payment.findByPaymentId(con,n);
							 %>
